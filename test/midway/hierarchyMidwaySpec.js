describe('fng-hierarchy', function () {
    ...
    describe('Integration tests', function () {
        ...
        describe('actions', function () {
            ...
            xit('should add a new entry form when clicking add', function () {
            ...
            it('display the correct icon if a new container is added', function () {
                ...
                scope.record.Hierarchy[8].isContainer = 'container';
            ...
            xit('removes the edit form if done is clicked and nothing has been entered', function () {
                var plusIcon = elm.find('.icon-plus-sign');
            ...
            describe('new form', function () {
                ...
                xit('should $emit an error if trying to add an element before saving the name in the form', function () {
